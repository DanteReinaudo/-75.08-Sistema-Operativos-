...
obj/user/evilhello.debug:     formato del fichero elf32-i386
...
umain(int argc, char **argv)
{
  ...
  800044:	e8 ba 00 00 00       	call   800103 <sys_cputs>
}
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000f2:	68 0a 1e 80 00       	push   $0x801e0a
  8000f7:	6a 23                	push   $0x23
  8000f9:	68 27 1e 80 00       	push   $0x801e27
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8003f5:	ba b4 1e 80 00       	mov    $0x801eb4,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800417:	51                   	push   %ecx
  800418:	50                   	push   %eax
  800419:	68 38 1e 80 00       	push   $0x801e38
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800806:	53                   	push   %ebx
  800807:	50                   	push   %eax
  800808:	68 58 1e 80 00       	push   $0x801e58
...
008009dc <devfile_write>:
{
  ...
  800a32:	c3                   	ret    
	assert(n <= PGSIZE - (sizeof(int) + sizeof(size_t)));
  800a33:	68 c4 1e 80 00       	push   $0x801ec4
  800a38:	68 f1 1e 80 00       	push   $0x801ef1
  800a3d:	68 94 00 00 00       	push   $0x94
  800a42:	68 06 1f 80 00       	push   $0x801f06
  800a47:	e8 47 06 00 00       	call   801093 <_panic>
	assert(r <= n);
  800a4c:	68 11 1f 80 00       	push   $0x801f11
  800a51:	68 f1 1e 80 00       	push   $0x801ef1
  800a56:	68 98 00 00 00       	push   $0x98
  800a5b:	68 06 1f 80 00       	push   $0x801f06
...
00800a65 <devfile_read>:
{
  ...
  800abe:	c3                   	ret    
	assert(r <= n);
  800abf:	68 11 1f 80 00       	push   $0x801f11
  800ac4:	68 f1 1e 80 00       	push   $0x801ef1
  800ac9:	6a 7c                	push   $0x7c
  800acb:	68 06 1f 80 00       	push   $0x801f06
  800ad0:	e8 be 05 00 00       	call   801093 <_panic>
	assert(r <= PGSIZE);
  800ad5:	68 18 1f 80 00       	push   $0x801f18
  800ada:	68 f1 1e 80 00       	push   $0x801ef1
  800adf:	6a 7d                	push   $0x7d
  800ae1:	68 06 1f 80 00       	push   $0x801f06
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bb4:	68 24 1f 80 00       	push   $0x801f24
  800bb9:	53                   	push   %ebx
...
00800c18 <_pipeisclosed>:
{
  ...
  800c5b:	50                   	push   %eax
  800c5c:	53                   	push   %ebx
  800c5d:	68 2b 1f 80 00       	push   $0x801f2b
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f12:	68 43 1f 80 00       	push   $0x801f43
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8010b3:	56                   	push   %esi
  8010b4:	50                   	push   %eax
  8010b5:	68 50 1f 80 00       	push   $0x801f50
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801226:	0f be 80 73 1f 80 00 	movsbl 0x801f73(%eax),%eax
  80122d:	50                   	push   %eax
...
008012dd <vprintfmt>:
{
  ...
  801405:	52                   	push   %edx
  801406:	68 03 1f 80 00       	push   $0x801f03
  80140b:	56                   	push   %esi
  80140c:	53                   	push   %ebx
  ...
  80141a:	50                   	push   %eax
  80141b:	68 8b 1f 80 00       	push   $0x801f8b
  801420:	56                   	push   %esi
  801421:	53                   	push   %ebx
  ...
  80143c:	b8 84 1f 80 00       	mov    $0x801f84,%eax
