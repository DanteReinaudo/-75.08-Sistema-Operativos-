...
umain(int argc, char **argv)
{
  ...
  80006c:	c3                   	ret    
		panic("spawn(hello) failed: %e", r);
  80006d:	50                   	push   %eax
  80006e:	68 04 24 80 00       	push   $0x802404
  800073:	6a 09                	push   $0x9
  800075:	68 1c 24 80 00       	push   $0x80241c
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80010b:	56                   	push   %esi
  80010c:	50                   	push   %eax
  80010d:	68 38 24 80 00       	push   $0x802438
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80027e:	0f be 80 5b 24 80 00 	movsbl 0x80245b(%eax),%eax
  800285:	50                   	push   %eax
...
00800335 <vprintfmt>:
{
  ...
  800472:	50                   	push   %eax
  800473:	68 73 24 80 00       	push   $0x802473
  800478:	56                   	push   %esi
  800479:	53                   	push   %ebx
  ...
  800494:	b8 6c 24 80 00       	mov    $0x80246c,%eax
