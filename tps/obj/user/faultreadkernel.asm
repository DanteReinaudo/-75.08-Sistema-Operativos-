	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800207:	0f be 80 31 1e 80 00 	movsbl 0x801e31(%eax),%eax
  80020e:	50                   	push   %eax
...
008002be <vprintfmt>:
{
  ...
  80030e:	3e ff 24 85 80 1f 80 	notrack jmp *0x801f80(,%eax,4)
  800315:	00 
  ...
  8003db:	8b 14 85 e0 20 80 00 	mov    0x8020e0(,%eax,4),%edx
  8003e2:	85 d2                	test   %edx,%edx
  8003e4:	74 15                	je     8003fb <vprintfmt+0x13d>
				printfmt(putch, putdat, "%s", p);
  8003e6:	52                   	push   %edx
  8003e7:	68 37 22 80 00       	push   $0x802237
  8003ec:	56                   	push   %esi
  8003ed:	53                   	push   %ebx
  ...
  8003fb:	50                   	push   %eax
  8003fc:	68 49 1e 80 00       	push   $0x801e49
  800401:	56                   	push   %esi
  800402:	53                   	push   %ebx
  ...
  80041d:	b8 42 1e 80 00       	mov    $0x801e42,%eax
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800a71:	68 3f 21 80 00       	push   $0x80213f
  800a76:	6a 23                	push   $0x23
  800a78:	68 5c 21 80 00       	push   $0x80215c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800d74:	ba e8 21 80 00       	mov    $0x8021e8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  800d96:	51                   	push   %ecx
  800d97:	50                   	push   %eax
  800d98:	68 6c 21 80 00       	push   $0x80216c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801004:	53                   	push   %ebx
  801005:	50                   	push   %eax
  801006:	68 ad 21 80 00       	push   $0x8021ad
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8010d5:	53                   	push   %ebx
  8010d6:	50                   	push   %eax
  8010d7:	68 c9 21 80 00       	push   $0x8021c9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801185:	53                   	push   %ebx
  801186:	50                   	push   %eax
  801187:	68 8c 21 80 00       	push   $0x80218c
...
0080135b <devfile_write>:
{
  ...
  8013b1:	c3                   	ret    
	assert(n <= PGSIZE - (sizeof(int) + sizeof(size_t)));
  8013b2:	68 f8 21 80 00       	push   $0x8021f8
  8013b7:	68 25 22 80 00       	push   $0x802225
  8013bc:	68 94 00 00 00       	push   $0x94
  8013c1:	68 3a 22 80 00       	push   $0x80223a
  8013c6:	e8 47 06 00 00       	call   801a12 <_panic>
	assert(r <= n);
  8013cb:	68 45 22 80 00       	push   $0x802245
  8013d0:	68 25 22 80 00       	push   $0x802225
  8013d5:	68 98 00 00 00       	push   $0x98
  8013da:	68 3a 22 80 00       	push   $0x80223a
...
008013e4 <devfile_read>:
{
  ...
  80143d:	c3                   	ret    
	assert(r <= n);
  80143e:	68 45 22 80 00       	push   $0x802245
  801443:	68 25 22 80 00       	push   $0x802225
  801448:	6a 7c                	push   $0x7c
  80144a:	68 3a 22 80 00       	push   $0x80223a
  80144f:	e8 be 05 00 00       	call   801a12 <_panic>
	assert(r <= PGSIZE);
  801454:	68 4c 22 80 00       	push   $0x80224c
  801459:	68 25 22 80 00       	push   $0x802225
  80145e:	6a 7d                	push   $0x7d
  801460:	68 3a 22 80 00       	push   $0x80223a
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801533:	68 58 22 80 00       	push   $0x802258
  801538:	53                   	push   %ebx
...
00801597 <_pipeisclosed>:
{
  ...
  8015da:	50                   	push   %eax
  8015db:	53                   	push   %ebx
  8015dc:	68 5f 22 80 00       	push   $0x80225f
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801891:	68 77 22 80 00       	push   $0x802277
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a32:	56                   	push   %esi
  801a33:	50                   	push   %eax
  801a34:	68 84 22 80 00       	push   $0x802284
  ...
  801a45:	e8 bc e6 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  801a4a:	c7 04 24 c2 22 80 00 	movl   $0x8022c2,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b0e:	c3                   	ret    
		panic("sys_ipc_try_send error: %d \n", ret);
  801b0f:	50                   	push   %eax
  801b10:	68 a7 22 80 00       	push   $0x8022a7
  801b15:	6a 48                	push   $0x48
  801b17:	68 c4 22 80 00       	push   $0x8022c4
